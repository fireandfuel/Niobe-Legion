 ...
 *
 * This file (Base64.java) is part of Niobe Legion (module niobe-legion-shared_main).
 *
...
public class Base64
{
    private final static Logger LOG = LogManager.getLogger(Base64.class);
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException
    {
        ...
        {
            boolean breakLines = (options & Base64.DO_BREAK_LINES) != 0;
    ...
    public static byte[] decode(String s, int options) throws java.io.IOException
    {
        ...
        boolean dontGunzip = (options & Base64.DONT_GUNZIP) != 0;
     ...
     * @since 2.3.4
     */
    public static Object decodeToObject(String encodedObject, int options, final ClassLoader loader) throws
                                                                                                     java.io.IOException,
                                                                                                     java.lang.ClassNotFoundException
    {
    ...
    public static byte[] decodeFromFile(String filename) throws java.io.IOException
    {
        ...
        try
        {
            ...
            {
                throw new java.io.IOException("File is too big for this convenience method (" + file
                        .length() + " bytes).");
