 ...
 *
 * This file (GroupAdminController.java) is part of Niobe Legion (module niobe-legion-client_main).
 *
...
{
    private final static Logger LOG = LogManager.getLogger(GroupAdminController.class);
